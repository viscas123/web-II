...
// topo do index.php - coloque isto no começo do arquivo (UTF-8 sem BOM)

if (isset($_SESSION['mensagem'])) {
    echo "<p style='color: green; font-weight: 700; margin: 10px 0;'>".htmlspecialchars($_SESSION['mensagem'])."</p>";
    unset($_SESSION['mensagem']);
}
if (isset($_SESSION['erro'])) {
    echo "<p style='color: red; font-weight: 700; margin: 10px 0;'>".htmlspecialchars($_SESSION['erro'])."</p>";
    unset($_SESSION['erro']);
}
?>
...
<div id="menu-user">
    <?php if( !isset($_SESSION['usuario'] )) : ?>
        <div><a href="login.php" class="menu">Login</a></div>
        <div><a href="cadastro.php" class="menu">Cadastro</a></div>
    <?php else : ?>
        <h4 style="position: relative; top: 10px; margin-left: 10px;">
            Bem vindo(a), <br> <?= $_SESSION['usuario']['nome'] ?>!
            <a href="logout.php" style="color: white; position: absolute;">Sair</a>
        </h4>
    <?php endif; ?>
</div>
